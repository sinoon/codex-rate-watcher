...
- **🔔 スマートアラートシステム** —— 設定可能なしきい値通知（50%、30%、15%、5%）、macOS ネイティブ通知対応、リセットウィンドウごとの重複排除、緊急度に応じたサウンドアラート
- **🎨 ダイナミックステータスバーアイコン** —— メニューバーアイコンがクォータの健全性に応じてリアルタイムに色変化（緑 → 黄 → 橙 → 赤）、アプリを開かずに一目で状況把握
