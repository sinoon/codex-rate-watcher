...
final class LarkSignatureSyncTests: XCTestCase {
  ...
  func testSignatureURLUsesSlotOnlyByDefault() throws {
    ...
    XCTAssertNil(queryItems["u"])
    XCTAssertTrue(signatureURL.absoluteString.contains("t=%7B%7Bslot%20id%3D%22slot-abc%22%7D%7D"))
    XCTAssertFalse(signatureURL.absoluteString.contains("&u="))
  }

  func testSignatureURLCanIncludeExplicitTargetURL() throws {
