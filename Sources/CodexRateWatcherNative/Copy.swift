...
enum Copy {
  ...
  static let costCopySignatureURL = "Copy URL"
  static let costCopySignatureURLCopied = "Copied"
  static let larkSignatureSectionTitle = "LARK SIGNATURE"
  static let larkSignatureTargetURLPlaceholder = "Target URL (optional)"
  static let larkSignatureSaveTargetURL = "Save"
  static let larkSignatureTargetSaved = "Saved"
  static let larkSignatureTargetInvalid = "Invalid"
